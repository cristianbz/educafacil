...
import ec.mileniumtech.educafacil.dao.PerfilDao;import java.util.ArrayList;
...
@LocalBean
@Stateless
public class PerfilDaoImpl extends GenericoDaoImpl<Perfil, Integer> implements PerfilDao {
