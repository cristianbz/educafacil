...
public class BackingProveedor implements Serializable {
	...
	private static final Logger log = LogManager.getLogger(BackingProveedor.class);
	...
	public void init() {
			...
			getBeanProveedor().setListaProveedores(contabilidadDataService.listaProveedores());
	...
	public void grabarProveedor() {
			...
			contabilidadDataService.agregarActualizarProveedor(getBeanProveedor().getProveedor());
			getBeanProveedor().setListaProveedores(new ArrayList<>());
			getBeanProveedor().setListaProveedores(contabilidadDataService.listaProveedores());
			setMostrarPanelNuevo(false);
